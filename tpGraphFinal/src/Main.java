...
public class Main {
	...
	public void parseFileGraph() {
		...
		try {
			...
			File fGraph = new File("C:\\test.txt");
			...
			while ((line = bReader.readLine()) != null) {
				...
				if (key.equals("sommet")) {
					...
					//System.out.println("---check ajout correct:"+ getMesIndices().get(monGraph.getNbSommet()));
					//System.out.println("--- valeur nom du sommet:"+value);
					//System.out.println("---Nb de sommet:"+ monGraph.getNbSommet());
				}
				if (key.equals("fin")) {
