...
<div style="padding-left:10px;margin-left:160px;margin-top:15px;border: 1px solid #c3d4eb; background-color:#e6e6fa;">
	<h1>Inscription module "Publicité sur Internet"</h1>
	<p/>
 <h:form id="inscriptionForm">
    <table>
    	<tr> <td> Société:</td> <td><h:inputText id="company" value="#{beanInfos.company}" /></td> </tr>   
 	    <tr> <td> Nom:</td> <td><h:inputText id="name" value="#{beanInfos.name}" /></td> </tr>    
	    <tr> <td> Prénom:</td> <td><h:inputText id="firstName" value="#{beanInfos.firstName}" /></td> </tr>   
 	    <tr> <td> eMail:</td> <td><h:inputText id="e_mail" value="#{beanInfos.e_mail}" /></td> </tr>   
 	    <tr> <td> téléphone:</td> <td><h:inputText id="telephone" value="#{beanInfos.telephone}" /></td> </tr>   
